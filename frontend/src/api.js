...
export const api = {
  ...
  pedidos: {
    ...
    listar: () => requisicao('/pedidos', { autenticado: true }),
    listarTodos: () => requisicao('/pedidos?todos=1', { autenticado: true }),
    alterarStatus: (id, status) =>
      requisicao(`/pedidos/${id}/status`, { metodo: 'PATCH', corpo: { status }, autenticado: true }),
  },
